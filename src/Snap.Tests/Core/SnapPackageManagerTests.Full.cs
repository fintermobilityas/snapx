...
namespace Snap.Tests.Core
{
    ...
    public class SnapPackageManagerFullTests : IClassFixture<BaseFixturePackaging>, IClassFixture<BaseFixtureNuget>
    {
        ...
        public SnapPackageManagerFullTests(BaseFixturePackaging baseFixturePackaging, BaseFixtureNuget baseFixtureNuget)
        {
                ...
                _baseFixturePackaging.WithSnapReleaseBuilder(rootDirectory, snapAppsReleases, genesisSnapApp, _releaseBuilderContext))
            {
                ...
                using (var genesisPackageContext = await _baseFixturePackaging.BuildPackageAsync(genesisReleaseBuilder))
                {
                    ...
                    var restoreSummary = await _snapPackageManager.RestoreAsync(packagesDirectory, snapAppChannelReleases,
                        packageSource, SnapPackageManagerRestoreType.FullAndDelta, progressSourceMock.Object);
                    ...
                    Assert.Equal(SnapPackageManagerRestoreType.FullAndDelta, restoreSummary.RestoreType);
